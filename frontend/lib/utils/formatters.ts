  ...
  switch (status) {
    case 'high_savings':
      return {
        ...
        borderClass: 'border-emerald-500/40 shadow-[0_0_30px_rgba(16,185,129,0.1)]',
      };
    case 'moderate_savings':
      return {
        ...
        borderClass: 'border-teal-500/40 shadow-[0_0_30px_rgba(20,184,166,0.1)]',
      };
    case 'optimal':
    default:
      return {
        ...
        borderClass: 'border-amber-500/40 shadow-[0_0_30px_rgba(245,158,11,0.1)]',
      };
  }
}
